...
class _WalletCategory_0 {
  ...
  toValue(value_0) {
    return _descriptor_0.toValue(value_0.subject).concat(_descriptor_3.toValue(value_0.category));
  }
}

const _descriptor_4 = new _WalletCategory_0();
...
export class Contract {
      ...
      init: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('init',
                                     ...
                                     'trust_attestation.compact line 80 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const result_0 = this._init_0(context, partialProofData, new_admin_0);
      ...
      add_oracle: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('add_oracle',
                                     'argument 1 (as invoked from Typescript)',
                                     'trust_attestation.compact line 87 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
      ...
      remove_oracle: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('remove_oracle',
                                     'argument 1 (as invoked from Typescript)',
                                     'trust_attestation.compact line 96 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(oracle_address_0.buffer instanceof ArrayBuffer && oracle_address_0.BYTES_PER_ELEMENT === 1 && oracle_address_0.length === 32)) {
      ...
      is_authorized: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('is_authorized',
                                     'argument 1 (as invoked from Typescript)',
                                     'trust_attestation.compact line 105 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(oracle_address_0.buffer instanceof ArrayBuffer && oracle_address_0.BYTES_PER_ELEMENT === 1 && oracle_address_0.length === 32)) {
      ...
      store_attestation: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('store_attestation',
                                     'argument 1 (as invoked from Typescript)',
                                     'trust_attestation.compact line 114 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(wallet_0).concat(_descriptor_3.toValue(category_0).concat(_descriptor_0.toValue(input_hash_0).concat(_descriptor_5.toValue(timestamp_0)))),
            alignment: _descriptor_0.alignment().concat(_descriptor_3.alignment().concat(_descriptor_0.alignment().concat(_descriptor_5.alignment())))
          },
          output: undefined,
          publicTranscript: [],
          privateTranscriptOutputs: []
      ...
      verify_claim: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('verify_claim',
                                     'argument 1 (as invoked from Typescript)',
                                     'trust_attestation.compact line 154 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(wallet_0.buffer instanceof ArrayBuffer && wallet_0.BYTES_PER_ELEMENT === 1 && wallet_0.length === 32)) {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(wallet_0).concat(_descriptor_3.toValue(category_0).concat(_descriptor_1.toValue(threshold_0))),
      ...
      get_attestation_hash: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('get_attestation_hash',
                                     'argument 1 (as invoked from Typescript)',
                                     'trust_attestation.compact line 168 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(wallet_0.buffer instanceof ArrayBuffer && wallet_0.BYTES_PER_ELEMENT === 1 && wallet_0.length === 32)) {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(wallet_0).concat(_descriptor_3.toValue(category_0)),
      ...
      get_category_count: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('get_category_count',
                                     'argument 1 (as invoked from Typescript)',
                                     'trust_attestation.compact line 180 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(wallet_0.buffer instanceof ArrayBuffer && wallet_0.BYTES_PER_ELEMENT === 1 && wallet_0.length === 32)) {
      ...
      transfer_admin: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('transfer_admin',
                                     'argument 1 (as invoked from Typescript)',
                                     'trust_attestation.compact line 189 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(new_admin_0.buffer instanceof ArrayBuffer && new_admin_0.BYTES_PER_ELEMENT === 1 && new_admin_0.length === 32)) {
  ...
  _caller_address_0(context, partialProofData) {
    ...
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.typeError('caller_address',
                                 'return value',
                                 'trust_attestation.compact line 69 char 1',
                                 'Bytes<32>',
                                 result_0)
    }
  ...
  _private_score_0(context, partialProofData) {
    ...
    if (!(typeof(result_0) === 'bigint' && result_0 >= 0n && result_0 <= 255n)) {
      __compactRuntime.typeError('private_score',
                                 'return value',
                                 'trust_attestation.compact line 75 char 1',
                                 'Uint<0..256>',
                                 result_0)
    }
    partialProofData.privateTranscriptOutputs.push({
  ...
  _init_0(context, partialProofData, new_admin_0) {
                       ...
                       timestamp_0)
  {
                                                                               ...
                                                                               result: undefined } }]).value))
    {
                                                                                ...
                                                                                result: undefined } }]).value))
      {
        ...
        const tmp_0 = ((t1) => {
                        if (t1 > 255n) {
                          throw new __compactRuntime.CompactError('trust_attestation.compact line 129 char 53: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 255');
                        }
                        return t1;
                      })(current_0 + 1n);
        __compactRuntime.queryLedgerState(context,
      ...
      member(...args_0) {
        ...
        if (!(key_0.buffer instanceof ArrayBuffer && key_0.BYTES_PER_ELEMENT === 1 && key_0.length === 32)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'trust_attestation.compact line 55 char 1',
                                     'Bytes<32>',
                                     key_0)
        }
        return _descriptor_2.fromValue(__compactRuntime.queryLedgerState(context,
    ...
    attestation_hashes: {
      ...
      member(...args_0) {
        ...
        if (!(typeof(key_0) === 'object' && key_0.subject.buffer instanceof ArrayBuffer && key_0.subject.BYTES_PER_ELEMENT === 1 && key_0.subject.length === 32 && key_0.category.buffer instanceof ArrayBuffer && key_0.category.BYTES_PER_ELEMENT === 1 && key_0.category.length === 16)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'trust_attestation.compact line 60 char 1',
    ...
    category_count: {
      ...
      member(...args_0) {
        ...
        if (!(key_0.buffer instanceof ArrayBuffer && key_0.BYTES_PER_ELEMENT === 1 && key_0.length === 32)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'trust_attestation.compact line 64 char 1',
                                     'Bytes<32>',
                                     key_0)
        }
        return _descriptor_2.fromValue(__compactRuntime.queryLedgerState(context,
